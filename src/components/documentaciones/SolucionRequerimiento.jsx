...
<body>
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const backendUrl = import.meta.env.VITE_BACKEND_URL || 'http://localhost:4000';
            await axios.post(`${backendUrl}/api/tickets`, {
                ticket,
                solicitud,
            ...
            toast.current.show({ severity: 'success', summary: 'Éxito', detail: 'Ticket guardado correctamente', life: 3000 });
        } catch (error) {
            console.error(error);
            toast.current.show({ severity: 'error', summary: 'Error', detail: 'No se pudo guardar el ticket', life: 3000 });
        }
    };
